...
<<<<<<< HEAD
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('locate', models.CharField(default='Not specified', max_length=16, verbose_name='region')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "locate",
                    models.CharField(
                        default="Not specified", max_length=16, verbose_name="region"
                    ),
                ),
                ("description", models.TextField(max_length=300, verbose_name="자기 소개")),
                (
                    "created_at",
                    models.DateField(auto_now_add=True, verbose_name="프로필 생성일"),
                ),
